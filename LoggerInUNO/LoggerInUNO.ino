...
const int chipSelect = 10;        // Pino conectado ao SC do Módulo SD.
const int redLed = 9;             // SDLed de Inicialização.
const int greenLed = 8;           // SDLed de Leitura do Arquivo.
const int pinButton = 7;          // pino do botão.
